...
class Database:
    ...
    def make_db(self):
        ...
        try:
            full_db = os.path.join(full_dir,self.db_name)
    ...
    def CreateUserTable(self):
        ...
        self.cursor.execute(create_table_querry)
        self.connection.commit()
    def InsertIntoAdmin(self,name,email,password):
        ...
        try:
            ...
            self.connection.commit()
            return {"value":True, "message":"Successfully added to the table"}
        except sqlite3.Error as e:
    ...
    def searchDataBase(self,table,field,value):
        ...
        try:
            ...
            list_found = self.cursor.fetchall()
            if list_found:
                return {"value":True,"message":"Here is what you are looking for","data":list_found}
            else:
                return{"value":False,"message":f"{value} not in the database","data":None}
        except sqlite3.Error as e:
            return{"value":False,"message":e,"data":None}
